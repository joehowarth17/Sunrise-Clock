...
# Date: Wed, 09 Aug 2017 04:07:40 GMT
#set_units -time ns
...
create_generated_clock -name {SPIM_1_IntClock} -source [get_pins {ClockBlock/hfclk}] -edges {1 25 49} [list [get_pins {ClockBlock/udb_div_0}]]
