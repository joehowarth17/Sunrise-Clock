...
module SPI_Master_v2_50_2 (
	...
	cy_clock_v1_0
		#(.id("a9a90a73-76fe-42d1-b7ed-33e1c3095120/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("6119d8ca-f1ec-4c4f-9d61-fc5f6d6db77b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8c036cad-94a6-4da1-9c47-d4b8c78372a4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
